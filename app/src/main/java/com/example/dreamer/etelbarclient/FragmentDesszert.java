...
public class FragmentDesszert extends android.support.v4.app.Fragment {
    ...
    private Query mQueriy;
    private AlphaAnimation buttonClick = new AlphaAnimation(1F, 0.8F);

    public FragmentDesszert() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.eloetel_fragment,container,false);
        mQueriy = mDatabase.orderByChild("category").equalTo("desszert");
        myrecyclerView = (RecyclerView) v.findViewById(R.id.eloetel_recycler);
